...
public class TabelaHashChaining {
    ...
    public void inserir(int valor) {
        System.out.println("Valor: " + valor + "\t\t" + valor + " % " + tamanho + " = " + Chave.getInstancia().gerarChave(valor, tamanho));
    ...
    public void inserir(String valor) {
        ...
        System.out.println(">>> " + valorNumerico + " % " + tamanho + " = " + Chave.getInstancia().gerarChave(valor, tamanho));
